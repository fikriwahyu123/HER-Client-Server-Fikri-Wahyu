 ...
 */
package com.fikri.anggotaservice.Controller;

import com.fikri.anggotaservice.Entity.Anggota;
import com.fikri.Anggotaservice.Service.AnggotaService;
...
public class AnggotaController {
    ...
    public Anggota saveAnggota(@RequestBody Anggota anggota){
        return (Anggota) anggotaService.saveAnggota(anggota);
    }
    
    @GetMapping("/{id}")
    public Anggota findAnggotaById(@PathVariable("id") Long anggotaId){
        return (Anggota) anggotaService.findAnggotaById(anggotaId);
    }
    
    @GetMapping("/")
    public List<Anggota> getAllAnggota(){
        return (List<Anggota>) anggotaService.getAllAnggota();
    }
    
    @PutMapping("/")
     public Anggota updateAnggota(@RequestBody Anggota anggota){
        return (Anggota) anggotaService.updateAnggota(anggota);
    } 
